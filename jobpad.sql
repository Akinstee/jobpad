...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2023 at 06:28 PM
...
INSERT INTO `admin` (`admin_id`, `fullname`, `email`, `password`, `created_at`, `updated_at`) VALUES
(1, 'Temitayo', 'akinstemi123@gmail.com', 'Faith12345', '2023-10-03 10:31:44', '2023-10-04 10:20:41');
...
CREATE TABLE `applicants` (
  ...
  `applicant_fullname` varchar(255) NOT NULL,
...
INSERT INTO `company` (`company_id`, `fullname`, `email`, `password`, `website`, `phone`, `logo`, `position`, `employee`, `employment`, `role`, `industry`, `description`, `address`, `lga`, `state`, `active`, `created_at`, `updated_at`) VALUES
(1, 'Teewhy', 'akinstemi123@gmail.com', 'pass1234', 'tech.com', '08149581154', NULL, 'MD', '3', 'FUll Time', 'CEO', 'Tech', 'Just a growing tech company', 'tedhtexample', 'isolo', 'Lagos', 2, '2023-10-18 16:00:22', '2023-10-18 16:00:22');
...
CREATE TABLE `job_applications` (
  `job_applications_id` int(11) NOT NULL,
...
CREATE TABLE `job_posts` (
  `job_post_id` int(11) NOT NULL,
  `job_post_company_id` int(11) NOT NULL,
  `applicants_id` varchar(255) DEFAULT NULL,
  `applicant_fullname` varchar(255) NOT NULL,
  `job_title` varchar(255) NOT NULL,
  `job_description` text NOT NULL,
  `job-level` varchar(255) NOT NULL,
  `job-function` varchar(255) NOT NULL,
...
ALTER TABLE `job_applications`
  ...
  ADD KEY `applicant_id` (`applicants_id`),
...
ALTER TABLE `job_posts`
  ...
  ADD UNIQUE KEY `applicant_name` (`applicant_fullname`),
  ADD UNIQUE KEY `applicants_id` (`applicants_id`),
  ADD KEY `company_id` (`job_post_company_id`);
...
--
ALTER TABLE `job_applications`
  MODIFY `job_applications_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `job_applications`
  ADD CONSTRAINT `job_applications_ibfk_1` FOREIGN KEY (`applicants_id`) REFERENCES `applicants` (`applicants_id`),
  ADD CONSTRAINT `job_applications_ibfk_2` FOREIGN KEY (`job_post_id`) REFERENCES `job_posts` (`job_post_id`);

--
-- Constraints for table `job_posts`
--
ALTER TABLE `job_posts`
  ADD CONSTRAINT `job_posts_ibfk_1` FOREIGN KEY (`job_post_company_id`) REFERENCES `company` (`company_id`);
COMMIT;
